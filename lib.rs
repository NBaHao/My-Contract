...
impl VotingContract {
    ...
    pub fn new() -> Self {
        ...
        VotingContract {
            ...
            result: None,
            last_epoch_height: 0,
            pass: "Vietnam Blockchain Summer School".to_owned(),
        }
    }
    ...
    fn check_result(&mut self) {
        ...
        if self.total_voted_stake > total_stake / 2 + 1 {
    ...
    pub fn vote(&mut self, is_vote: bool, password: String) {
        assert!(password == self.pass, "Wrong Password, Can't vote");
        self.ping();
